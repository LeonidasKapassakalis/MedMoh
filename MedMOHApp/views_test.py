...
#         rev = reverse('MedMOHApp:detailexambiodet', kwargs={'pk': str(record.pk)})
#         return mark_safe('<a href=' + rev + u'><span style="color:green">Λεπ.</span></a>')
#     def render_update(self, record):
#         rev = reverse('MedMOHApp:updateexambiodet', kwargs={'pk': str(record.pk)})
#         return mark_safe('<a href=' + rev + u'><span style="color:blue">Μετ.</span></a>')
#     def render_delete(self, record):
#         rev = reverse('MedMOHApp:deleteexambiodet', kwargs={'pk': str(record.pk)})
...
#                    'param_action1': reverse('MedMOHApp:createexambiodet'),
